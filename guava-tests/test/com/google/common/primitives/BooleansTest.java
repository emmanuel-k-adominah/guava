...
public class BooleansTest extends TestCase {
  ...
  public void testAsListIsEmpty() {
    assertThat(Booleans.asList(EMPTY)).isEmpty();
    assertThat(Booleans.asList(ARRAY_FALSE)).isNotEmpty();
  }

  public void testAsListSize() {
    assertThat(Booleans.asList(EMPTY)).isEmpty();
    assertThat(Booleans.asList(ARRAY_FALSE)).hasSize(1);
    assertThat(Booleans.asList(ARRAY_FALSE_TRUE)).hasSize(2);
  }
  ...
  public void testAsListContains() {
    assertThat(Booleans.asList(EMPTY)).doesNotContain((Object) "wrong type");
    assertThat(Booleans.asList(EMPTY)).doesNotContain(true);
    assertThat(Booleans.asList(ARRAY_FALSE)).doesNotContain(true);
    assertThat(Booleans.asList(ARRAY_TRUE)).contains(true);
    assertThat(Booleans.asList(ARRAY_FALSE_TRUE)).contains(false);
    assertThat(Booleans.asList(ARRAY_FALSE_TRUE)).contains(true);
  }

  public void testAsListEquals() {
    assertThat(Booleans.asList(EMPTY)).isEqualTo(Collections.emptyList());
    assertThat(Booleans.asList(ARRAY_FALSE)).isEqualTo(Booleans.asList(ARRAY_FALSE));
    ...
    assertThat(reference).isEqualTo(Booleans.asList(ARRAY_FALSE));
